		...
		<div class="container bg5">
			...
			<div class="contents" id="Contents">
				...
				<div class="content" id="Content">
						...
						<tbody>
							<tr>
								<c:forEach var="i" items="${list}" varStatus="cnt">
									<th scope="row">제목</th>
									<td class="left" id="subject">${i.l_title}</td>
									<th scope="row">등록일</th>
									<td id="registeDt">${i.l_regdate}</td>
							</tr>
							<tr>
								<th scope="row">이메일</th>
								<td class="left" id="file">${i.l_email}</td>
								<th scope="row">작성자</th>
								<td id="nView">${i.l_name}</td>
							</tr>
							<tr>
								<th scope="row">조회수</th>
								<td id="nView">${i.l_hit}</td>
							</tr>
							<tr>
								<td colspan="4" class="cont" id="content"><img
									src="/upload/${i.l_fileFileName} " width="400" height="400" />
								<!--사진첨부 들어가는 곳  --></td>
							</tr>
							<tr>
								<td colspan="4" class="cont" id="content">${i.l_contents}<!--글 내용 부분  -->
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="board_list2" summary="이전글, 다음글">
						...
						<tbody>
							<tr id="prevTr">
								...
								<td><a href="#" id="prevSubject"></a></td>
								<td id="prevRegisteDt"></td>
							</tr>
							<tr id="nextTr">
								<th scope="row" class="next">다음글</th>
								<td><a href="#" id="nextSubject"></a></td>
					...
					<div class="btn_center">
						...
						<a
							href="/bustagoApp/lostLoginCheckAction.action?l_no=${i.l_no}&job=modify">수정</a>
						<a
							href="/bustagoApp/lostLoginCheckAction.action?l_no=${i.l_no}&job=delete">삭제</a>
						<a href="/bustagoApp/lostListAction.action">목록</a>
