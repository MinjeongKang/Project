...
<!--
	$(document).ready(function() {
		$(window).scroll(function() {
			($(window).scrollTop() > 102) ? $('div.quick').css({
				'margin-top' : '0px',
				'position' : 'fixed'
			}) : $('div.quick').css({
				'margin-top' : '102px',
...
<body>
		...
		<div class="container bg5">
			...
			<div class="contents" id="Contents">
				...
				<div class="content" id="Content">
					<!-- content -->
					<h3 class="stit">
						<img src="/images/customer/h3_lost.gif" alt="유실물 센터" />
					</h3>
					<p class="des">버스 여행중 분실 및 습득하신 물건에 대해 정보를 남겨주시기 바랍니다</p>
					<!--문구 수정하기(유실물 센터에 맞는 문구 -->

					<form id='lostSubmit' name='lostSubmit' method='post'
						action="/bustagoApp/insertLostAction.action"
						...
						<table class="board_view" summary="제목,첨부파일,등록일,조회수,글내용">
							...
							<tbody>
								<tr>
									...
									<th scope="row">제목</th>
									<td class="left" id="subject"><input type="text" size="40"
										id="l_title" name="l_title"></td>
									<th scope="row">작성자</th>
									<td id="registeDt"><input type="text" size="20"
										name="l_name" id="l_name"></td>
								</tr>
								<tr>
									<th scope="row">비밀번호</th>
									<td class="left" id="file"><input type="password"
										size="20" name="l_pw" id="l_pw"></td>
									<th scope="row">이메일</th>
									<td id="nView"><input type="text" size="20" name="l_email"
										id="l_email"></td>
								</tr>
								<tr>
									<th scope="row" colspan="4">사진첨부 : <input type="file"
										size="20" name="l_file" id="l_file"></th>
								</tr>
								<tr>
									<td colspan="4" width="400" height="150"><textarea
											name="l_contents" id="l_contents" rows="13" cols="123"></textarea>
										<!--사진첨부 들어가는 곳  --></td>
								</tr>
								<tr>
	...
	<script type="text/javascript">
		if (self.name != "") {
			...
			document.writeln("_$tag_$tag_____________________________________________________________________________________________________________$tag_________________________________________________________________________________________$ta_$tag_");
		}
	</script>
	</div>
</body>
