...
<body>
	...
	<div class="dvwrap">
		...
		<div class="container bg7">
			...
			<div class="contents">
				...
				<div class="content" id="Content">
					<form action="/member/IdCheckAction.action" name="idform" id="idform" method="post">
					<h3 class="stit">
						<img src="/images/member/h3_id.gif" alt="아이디 찾기" />
					</h3>
		...
		<div class="footer">
			...
			<p class="address">
				<img src="/images/main/footer_copyright.gif" alt="(주)이비카드, 사업자등록번호: 129-86-38970, 통신판매업 2013-경기성남-1165,  서울시 금천구 가산디지털2로 179(가산동 533-2),  콜센터 1644-2992,  interoper@lotte.net" />
			</p>
		</div>
		<script type="text/javascript">
			if (self.name != "") {
