...
<div class="content" id="Content">
   ...
   <div class="reserveboxs">
         <form action="/bustagoApp/yedataSearchAction.action" name="cardFrm" id="cardFrm" method="post">
            ...
            <label for="check">
               카드 번호 입력 : <input type="text" name="bnumber1" id="bnumber1" size="15"/> - <input type="text" size="15" name="bnumber2" id="bnumber2"/> - <input type="text" size="15" name="bnumber3" id="bnumber3"/> - <input type="text" size="15" name="bnumber4" id="bnumber4"/>
            <input type="hidden" name="bnumber" id="bnumber"/>
            <a style="cursor: pointer;" class="search" id="searchBtn"><img src="/images/common/bts_check.gif" id="save" name="save" alt="조회하기"  /></a>
      ...
      <table class="board_view" summary="제목,첨부파일,등록일,조회수,글내용">
         ...
         <tr>
              <c:forEach var="i" items="${yedatalist}" varStatus="cnt">   
               ...
               <th scope="row">성인 및 아동 수</th>
               <td id="registeDt">성인 : "${i.a_cnt}" / 아동 : "${i.k_cnt}"</td>
            </tr>
            <tr>
       <th scope="row">예매승인결과</th>
