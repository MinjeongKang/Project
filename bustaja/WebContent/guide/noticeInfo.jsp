...
<body>
	...
	<div class="dvwrap">
		...
		<div class="content" id="Content">
			<h3 class="stit"><img src="/images/customer/h3_notice.gif" alt="공지사항" /></h3>
			<p class="des">버스타자(전국시외버스 통합전산망)의 새로운 소식을 알려드립니다.</p>
			...
			<div class="btn_center">
				<a href="#" id="listBtn"><img src="/images/common/btn_list.gif" alt="목록" /></a>
			</div>
		</div>
