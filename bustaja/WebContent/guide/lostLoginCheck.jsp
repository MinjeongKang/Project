...
$(document).ready(function() {
    $("img#pwcheck").click(function(){
    	if($("input[id=l_pw]").val().length==0){
    	alert('비밀번호를 입력하세요');
    	return;    	
    	}
    	else{
...
<li><a href="/bustagoApp/lostListAction.action">유실물센터</a></li>
				...
				<div class="content" id="Content">
					...
					<center>게시글에 해당하는 비밀번호를 입력하여 주시기바랍니다</center>
					
			
					<div>
						<form name="login" method="post" action="/bustagoApp/lostLoginCheckAction.action" id="login">
							<div align="center">
							<br><br>
								<table align="center">
								<tr>
								<th>비밀번호　</th>
								<td>　　<input type="password" id="l_pw" name="l_pw"></td>
								<td>　<img src="/images/button/bts_login.gif" alt="로그인" id="pwcheck" name="pwcheck" width="60"/></td>
								</table>
