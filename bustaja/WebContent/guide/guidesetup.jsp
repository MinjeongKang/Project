		...
		<div class="container bg6">
			...
			<div class="location">
				<a href="/kr/index.do" class="home">HOME</a> &gt; <a
					href="/kr/guide/info.do">이용안내</a> &gt; <a class="state">설정안내</a>
			</div>
			...
			<div class="contents">
				...
				<div class="content" id="Content">
					<!-- contents -->
					<h3 class="stit">
						<img src="/images/guide/h3_setup.gif" alt="팝업설정안내" />
					</h3>

					<div class="gsetup">
						<p>본 버스타고 시외버스 승차권 인터넷 예매 서비스는 브라우저의 팝업 차단 설정을 해제해 주셔야 서비스를
							원활히 이용하실 수 있습니다.</p>
						<p>
							<img src="/images/guide/popup_block.png" />
						</p>
					</div>
					...
					<div class="gbox">
						<div class="btm">
							<div class="top">
								<img src="/images/guide/setup_img01.gif" alt="인터넷옵션" />
								<div class="tt">
									<img src="/images/guide/setup_img02.gif" alt="팝업차단설정" />
								</div>
							</div>
						</div>
					</div>
