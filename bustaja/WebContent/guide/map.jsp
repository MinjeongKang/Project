...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("a#transBtn").click(function() {
			$("div.dvwrap").hide();
			$.ajax({
				url : '/guide/transportation.htm',
				dataType : 'html',
				success : function(data) {
					$("div.dvwrap").html(data);
					$("div.dvwrap").show();
	...
	<div class="dvwrap">
		...
		<div class="container bg3">
			<div class="location">
				...
				<a href="/kr/transport_information/map.do">운행정보</a> &gt; 
				<a class="state">운행/노선 정보</a>
			</div>
				...
				<div class="lnbs" id="Lnb">
					...
					<div class="slnb">
						<ul class="lnb" id="transport_information">
							<li class="sta"><a href="#" id="mapBtn">운행/노선 정보</a></li>
							<li class="end"><a href="#" id="transBtn">버스회사 안내</a></li>
						</ul>
					</div>
					<!-- //lnb -->
				</div>

				<div class="content" id="Content" style="min-height: 340px;">
					<!-- content -->
					<h3 class="stit">
						<img src="/images/service/h3_service.gif" alt="운행/노선 정보" />
					</h3>

					<div id="busRouteAreaSearch" class="servicebox seletw">
						<p class="">지역을 선택하시면, 해당지역의 시외버스 터미널 및 정류소 정보가 보여집니다.</p>
						<label for="start">출발지역 선택</label> &nbsp; 
						<select style="width: 135px;" id="routeStart">
							<option value="">선택하세요</option>
							<option value="0">서울특별시</option>
						</select> &nbsp; <label class="tt" for="arrial">도착지역 선택</label> &nbsp; 
						<select style="width: 135px;" id="routeEnd">
							<option value="">선택하세요</option>
							<option value="0">서울특별시</option>
						</select> &nbsp; <a href="#" class="search" id="search"><img
							src="/images/button/bts_check_service.gif" alt="조회하기" /></a>
					</div>

					<p class="mess" id="mess">
						<span>출발하시는 지역과 도착하시는 지역을 선택해주세요.</span>
					</p>
