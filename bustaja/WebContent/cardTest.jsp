...
<script type="text/javascript">
	$(document).ready(function() {
		$("img#selectBtn").click(function() {
			//$("form#search").submit();
		});
	});
	// 검색 값 던지는 기능 
	function searchOption() {
		var inputText = document.getElementById('c_no').value;
		//alert(inputText);
	...
	<div class="dvwrap">
		...
		<div class="container bg1">
			<div class="location">
				...
				<a Shref="/kr/ticket/ticket.do">승차권 예매</a> &gt; 
				<a class="state">승차권 예매</a>
			</div>
			...
			<div class="contents" id="Contents">
				<div class="content" id="Content">
					<div class="reservebox" style="width:325px; height: 125px;">
						<form action="/bustagoApp/searchDataAction.action" name="search" id="search" method="post">
							<input type="hidden" id="y_id" name="y_id" value="${y_id}" /><br>
							카드종류 : <select id="c_type" name="c_type">
								<option value="일반">일반</option>
								<option value="법인">법인</option>
							</select> 
							카드사 : <select id="c_name" name="c_name">
							...
							카드번호 : <input type="text" size="30" id="c_no" name="c_no"><br> 
							유효기간 : <input type="text" size="10" id="c_age" name="c_age">('/' 제외하고 기입)<br>
							결제금액 : <input type="text" size="10" id="totalcost" name="totalcost" value="${totalcost}" readonly="readonly"> 
							<br>
							<input type="button" id="selectBtn" name="selectBtn" value="결제하기" onclick="searchOption()" />
						</form>
					</div>
				</div>
			</div>
