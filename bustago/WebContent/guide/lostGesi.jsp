		...
		<div class="container bg5">
			...
			<div class="contents" id="Contents">
				...
				<div class="content" id="Content">
					...
					<!-- content -->
					<h3 class="stit">
						<img src="/images/customer/h3_lost.gif" alt="분실물센터" />
					</h3>
					<p class="des">소지품 분실 및 습득 시 정보를 공유하여 소중한 소지품을 찾길 바랍니다</p>

					<form id="noticeForm" action="/kr/support/notice/notice.do"
						method="post">
						<input type="hidden" name="searchSelect" value="" /> <input
					...
					<table class="board_list" summary="번호,제목,첨부,등록일,조회수">
						...
						<tbody>
							...
							<c:forEach var="i" items="${lostlist}" varStatus="cnt">
								<tr>
									<td>${cnt.count }</td>
									<td><a
										href="/bustagoApp/lostInfoViewAction.action?l_no=${i.l_no}"><img
											src="/upload/${i.l_fileFileName}" width="50" height="50" /></a></td>
									<td><a
										href="/bustagoApp/lostInfoViewAction.action?l_no=${i.l_no}">${i.l_title }</a></td>

									<%-- 	<a href="/cartApp/deleteCart.action?pk=${i.pk}" --%>
					...
					<br> <a href="/guide/addLost.jsp"><img
							src="/images/button/btn_upload.gif" align="right"></a>


						<div class="paginate_complex paging" id="nav">${sbfr }</div>
