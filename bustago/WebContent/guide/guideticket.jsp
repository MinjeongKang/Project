	...
	<div class="dvwrap">
		...
		<div class="container bg6">
			...
			<div class="location">
				...
				<a href="/kr/guide/info.do">이용안내</a> &gt; <a class="state">승차권 예매/취소/변경 안내</a>
			</div>
			...
			<div class="contents">
				...
				<div class="content" id="Content">
					<!-- contents -->
					<h3 class="stit">
						<img src="/images/guide/h3_ticket.gif" alt="승차권 예매/취소/변경 안내" />
					</h3>

					<div class="tguide">
						<strong class="gtit"><img
							src="/images/guide/ticket_tit01.gif" alt="승차권 예매" /></strong>
						<p>
							본 버스타고 시외버스 승차권 인터넷 예매 서비스는 고객님께서 터미널에 방문하지 않고 컴퓨터의 <br /> 웹
							브라우저를 이용하여 원하시는 시외버스 승차권을 구입하시는데 제공되는 서비스 입니다.
						</p>
						<p>
							승차권예매 시 인터넷 예매 서비스를 제공하는 터미널과(왕복/편도) 자유석(비 좌석예매)및 운행정보를 <br />
							제공하는 터미널을 확인하시어 다양한 결제수단으로 인터넷 예매서비스를 이용하실 수 있습니다. <br /> 승차권 예매
							결제 시 일부 체크카드 및 법인카드는 예매가 제한될 수 있습니다.
						</p>
						<div class="bts">
							<a href="/kr/ticket/ticket.do">
							<img src="/images/button/bts_reserve.gif" alt="예매하기" /></a>
						</div>
					</div>

					<div class="tguide bg2">
						<strong class="gtit"><img
							src="/images/guide/ticket_tit02.gif" alt="승차권 조회/변경/취소" /></strong>
						<p>
							버스타고 서비스를 이용한 예매는 인터넷 통신을 통해 실시간으로 처리 됩니다. <br /> 그러나 때때로 회선의
							장애나 브라우저의 환경, 바이러스 등으로 인한 통한 장애로 인하여 카드 결제 후 <br /> 예매성공 여부를 정확히
							전달하지 못하는 경우가 있을 수 있으므로 예매 후에는 반드시 승차권 조회/변경/취소 <br /> 메뉴를 통해
							예매성공여부를 <br /> 확인해 주시기 바랍니다.
						</p>
						<p>
							비회원으로 예매하신 고객님은 승차권 조회/변경/취소 메뉴를 통해 승차권 조회와 예매변경, 취소 서비스를 <br />
							이용하기 위해서는 승차권 예매시 사용한 카드번호 또는 생년월일 및 전화번호를 알고 계셔야 합니다.
						</p>
						<p>
							예매한 승차권을 발권하실 때에는 반드시 예매에 사용하셨던 카드를 지참하셔야 하며, 출발 터미널 매표 <br />
							창구에서 카드를 제시한 후 인터넷 예매 승차권 발급을 요청하시거나 인터넷 예매 승차권 발급용 무인 <br />
							발권기가 설치되어 있는 경우 해당 기기에 카드를 읽혀 주시면 예매하신 승차권을 발급받으실 수 있습니다.
						</p>
						<p>
							예매 변경 시 좌석 변경은 별도의 결제정보 입력 없이 바로 변경 가능하며, 시간 및 버스등급 변경 시 기존에 <br />
							예매한 결제가 자동취소 된 후 재 결제가 이루어지므로 중복 결제는 되지 않습니다.<br /> 보다 정확한 확인을
							위해선 해당 카드사로 문의해 주시기 바랍니다.
						</p>
						<div class="bts">
							<a href="/kr/reserve/reservelist.do">
							<img src="/images/button/bts_check_change.gif" alt="승차권 조회/변경/취소 가기" /></a>
						</div>
					</div>

					<div class="tguide bg3">
						<strong class="gtit"><img
							src="/images/guide/ticket_tit03.gif" alt="유의사항" /></strong>
						<p>출발시간이 지나신 경우에는 예매하신 승차권을 발급받으실 수 없습니다.</p>
						<p>
							예매에 사용한 카드를 분실하셨거나 재발급 받아 예매 시 사용하셨던 카드번호를 기억하지 못하시는 경우 <br />
							예매 시 입력하셨던 생년월일 및 전화번호로 창구발권이 가능하오니 터미널에서 운영중인 유인 창구로 문의해 <br />
							주시기 바랍니다.
						</p>
						<p>
							카드사로 매입 정보가 이미 접수된 상태에서 예매 취소를 하는 경우 카드승인 취소에 <strong>약
								7일의 기간</strong>이 소요될 수 <br /> 있습니다. 카드승인취소 여부가 확인되지 않는 경우에는 해당 카드사로 문의해
							주시기 바랍니다.
						</p>
					</div>
				</div>
