		...
		<div class="container bg5">
			<div class="location">
				<a href="/kr/index.do" class="home">HOME</a> &gt; <a
					href="/kr/support/notice/notice.do">관리자모드</a> &gt; <a class="state">공지사항관리</a>
			</div>
			...
			<div class="contents" id="Contents">
				...
				<div class="content" id="Content">
					...
					<form id="noticeFrm" name="noticeFrm"
						action="/bustagoApp/AdminNoticeDelete.action" method="post">
							...
							<tbody>
								<c:forEach var="i" items="${noticelist}" varStatus="cnt">
									<tr>
										...
										<td>${i.n_hit}</td>
										<td>${i.regdate}</td>
										<td><input type="button" name="deleteNotice"
											id="deleteNotice" value="삭제" onclick="deletefun()" /></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
					</form>
					<button type="button">글쓰기 추가</button>
				</div>
			</div>
		</div>
