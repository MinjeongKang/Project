...
<body>
	...
	<div class="dvwrap">
		...
		<div class="container bg7">
			<!-- content -->
			<div class="location">
				<a href="/kr/index.do" class="home">HOME</a> &gt; <a class="state">마이페이지</a>
			</div>

			<h2 class="title">
				<img src="/images/mypage/h2.gif" alt="마이페이지" />
			</h2>
			...
			<div class="contents">
				<div class="lnbs">
					...
					<div class="slnb">
						<ul class="lnb">
							<li><a href="/member/mypageAction.action" id="">회원정보 확인</a></li>
							<li><a href="#" id="">회원정보 변경</a></li>
							<li><a href="#" id="">회원 탈퇴</a></li>
						</ul>
				...
				<div class="content" id="Content">
					<!-- contents -->
					<h3 class="stit">
						<img src="/images/mypage/h3_mypage.gif" alt="마이페이지" />
					</h3>
					...
					<div class="rbtn">
						<a href="/kr/mypage/myProfile.do"><img
							src="/images/button/bts_change_member.gif" alt="회원정보 변경" /></a>
					</div>
					...
					<!-- 
					<h4 class="stit">
						<img src="/images/mypage/h4_ticket_reserve.gif" alt="승차권 예매 현황" />
					</h4>
					<p class="mytxt">
						최근 7일 이내에 <strong class="point1"><span
							id="reserveTotalCnt"></span></strong>건의 승차권 예매정보가 있습니다.<br />본 페이지에서는 최근
						3건만 보여지며, 나머지 내역은 더보기 버튼을 이용하여 확인하시기 바랍니다. <a
							href="/kr/reserve/reservelist.do" class="bts"><img
							src="/images/button/bts_more.gif" alt="더보기" /></a>
					</p>
					<table class="type tline space1"
						summary="예매일, 출발일, 출발지, 도착지, 출발시간, 등급, 매수, 금액, 예매상태">
						<caption>승차권 예매 현황</caption>
						<colgroup>
							<col style="width: 14%;" />
							<col style="width: 14%;" />
							<col style="width: 15%;" />
					...
					<!-- 
					<h4 class="stit">
						<img src="/images/mypage/h4_mtom.gif" alt="1:1 문의" />
					</h4>
					<p class="mytxt">
						최근 7일 이내에 <strong class="point1">0</strong>건의 1:1 문의 내역이 있습니다.<br />본
						페이지에서는 최근 3건만 보여지며, 나머지 내역은 더보기 버튼을 이용하여 확인하시기 바랍니다. <a
							href="/kr/mypage/myQuestionList.do" class="bts"><img
							src="/images/button/bts_more.gif" alt="더보기" /></a>
					</p>
					<form id="viewForm" action="/kr/mypage/myQuestionView.do"
						method="POST">
					...
					<table class="board_list" summary="">
						...
						<thead>
							<tr>
								<th scope="col" class="btn"><input type="checkbox"
									id="allCheck" /></th>
								<th scope="col">유형</th>
								<th scope="col">제목</th>
								<th scope="col">등록일</th>
						...
						<tbody>
							<tr>
								<td colspan="5"><span class="result">1:1 문의 내역이
										없습니다.</span></td>
							</tr>
						</tbody>
					</table>
		...
		<div class="laybox" id="loading" style="display: none;">
			<img id="loading" src="/images/common/load.gif" />
		</div>
