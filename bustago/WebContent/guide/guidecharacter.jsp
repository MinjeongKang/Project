		...
		<div class="container bg6">
			...
			<div class="location">
				<a href="/kr/index.do" class="home">HOME</a> &gt; <a
					href="/kr/guide/info.do">이용안내</a> &gt; <a class="state">캐릭터 안내</a>
			</div>
			...
			<div class="contents">
				...
				<div class="content" id="content">
					<h3 class="stit">
						<img src="/images/guide/h3_character.gif" alt="캐릭터 안내" />
					</h3>

					<div class="character">
						<img src="/images/guide/character_img.gif" alt="캐릭터 티티"
							class="pic" /> <strong><img
							src="/images/guide/character_tit.gif" alt="티티캐릭터" /></strong>
						<p>
							<img src="/images/guide/character_txt.gif" alt="캐릭터 안내" />
						</p>
						<div>
							<a href="/download/character_jpg.zip"><img
								src="/images/guide/btn_jpg.gif" alt="jpg다운로드" /></a> 
							<a href="/download/character_ai.zip"><img
								src="/images/guide/btn_ai.gif" alt="ai다운로드" /></a>
						</div>
					</div>

					<div class="titi">
						<strong><img src="/images/guide/character_tit2.gif"
							alt="응용형 티티" /></strong>
						<div>
							<img src="/images/guide/character_img01.gif" alt="티티 캐릭터" />
						</div>
					</div>
				</div>
			</div>
