			...
			<div class="tinfo">
				<ul>
					...
					<li class="sta" id="loginOutBtn">
						<a href="/guide/login.jsp"><img src="/images/main/gnbs_01.gif" alt="로그인" /></a>
					</li>
					<li id="certificate">
					...
					<li>
						<a href="/guide/mypage.jsp"><img src="/images/main/gnbs_03.gif" alt="마이페이지" /></a>
					</li>
					<li>
						<a href="#"><img src="/images/main/sitemap.gif" alt="사이트맵" /></a>
					</li>
				</ul>
			</div>
			<div class="gnb">
				...
				<ul class="menus">
					...
					<li id="menu03">
						...
						<ul class="gnb03">
							...
							<li><a href="/guide/transportation.jsp">버스회사 안내</a></li>
						</ul>
					</li>
...
<div class="content" id="Content">
	...
	<center>
	<img src="/images/common/comple.JPG" align="center">
	</center>
	...
	<div class="quick">
		<div class="quick1">
			<div class="cock">
				<img src="/images/common/quick_show.png" alt="" class="qshow" />
			</div>
			<ul>
				<li><a href="/kr/ticket/ticket.do"><img
						src="/images/common/quick_s01.gif" alt="승차권예매" title="승차권예매" /></a></li>

				<li><a href="/kr/reserve/reservelist.do"><img
						src="/images/common/quick_s03.gif" alt="예약확인/조회" title="예약확인/조회" /></a></li>

				<li><a href="/kr/guide/info.do"><img
						src="/images/common/quick_s05.gif" alt="이용안내" title="이용안내" /></a></li>
			</ul>
			<div>
				<a href="#Gnb"><img src="/images/common/quick_stop.gif"
					alt="맨위로" /></a>
			</div>
		</div>
		<div class="quick2">
			<div class="cock">
				<img src="/images/common/quick_hide.png" alt="" class="qhide" />
			</div>
			<ul>
				<li><a href="/kr/ticket/ticket.do"><img
						src="/images/common/quick_01.gif" alt="승차권예매" title="승차권예매" /></a></li>

				<li><a href="/kr/reserve/reservelist.do"><img
						src="/images/common/quick_03.gif" alt="예약확인/조회" title="예약확인/조회" /></a></li>

				<li><a href="/kr/guide/info.do"><img
						src="/images/common/quick_05.gif" alt="이용안내" title="이용안내" /></a></li>
			</ul>
			<div class="top">
