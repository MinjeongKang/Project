...
$(document).ready(function() {
	$("a#submitBtn").click(function() {
		if ($("input[id=m_ID]").val().length == 0 || $("input[id=m_NAME]").val().length == 0 || $("input[id=M_EMAIL]").val().length == 0) {
			alert('ID | 이름 | E-MAIL을 확인하여주세요');
			$("input[id=m_ID]").val('');
			$("input[id=m_NAME]").val('');
		...
		<div class="container bg7">
			...
			<div class="contents">
				...
				<div class="content" id="Content">
					<form action="/member/passCheckAction.action" name="pkform" id="pkform" method="post">
					<h3 class="stit">
						<img src="/images/member/h3_pw.gif" alt="비밀번호 찾기" />
					</h3>

					<h4 class="stit">
						<img src="/images/member/h4_check.gif" alt="본인확인" />
					</h4>
					<p class="des2">회원 본인임을 확인하기 위해서, 본인인증이 필요합니다.</p>

					<table class="member" summary="이름, 인증방법">
						...
						<tbody>
							<tr>
								<th scope="row" class="ee"><label for="name">아이디</label></th>
								<td>
									<input type="text" id="m_ID" name="m_ID" class="txt" style="width: 200px;" />
								</td>
							</tr>
							<tr>
								<th scope="row" class="ee"><label for="name">이름</label></th>
								<td>
									<input type="text" id="m_NAME" name="m_NAME" class="txt" style="width: 200px;" />
								</td>
							</tr>
							<tr>
								<th scope="row" class="ee"><label for="name">E-MAIL</label></th>
								<td>
									<input type="text" id="M_EMAIL" name="M_EMAIL" class="txt" style="width: 200px;" />
								</td>
							</tr>
						</tbody>
					</table>
					...
					<div class="btn_center">
						<a id="submitBtn">
							<img src="/images/button/btn_ok.gif" alt="확인" />
						</a>
					</div>

					<div class="idbox">
						<div class="id_l">
							<strong><img src="/images/member/id_tit01.gif"
								alt="아이디/비밀번호 찾기 및 분실 FAQ" /></strong>
							<p>
								빠른 답변을 통해 아이디 / 비밀번호를 <br /> 찾으실 수 있습니다.
							</p>
							<a href="/kr/support/faq/faq.do"><img
								src="/images/button/bts_faq.gif" alt="FAQ 바로가기" /></a>
						</div>
						<div class="id_r">
							<strong><img src="/images/member/id_tit02.gif"
								alt="콜센터 문의" /></strong>
							<p>
								아이디 / 비밀번호 찾기가 어려우신 분은 아래의<br />콜센터로 문의 바랍니다. <span><img
									src="/images/member/id_no.gif" alt="1644-2992" /></span>
							</p>
						</div>
					</div>
					</form>
